...
const LoginPage: React.FC<{ setAuthView: (v: AuthView) => void }> = ({ setAuthView }) => {
    ...
    return (
        <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-2xl border-2 border-[#F0FDF4] relative">
            ...
            <h2 className="text-3xl font-bold text-center text-[#047857] mb-2">{T.nav.login}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                    ...
                    <input 
                        ...
                        required 
                        className="w-full px-4 py-3 border-2 border-[#F0FDF4] rounded-lg focus:border-[#047857] focus:ring-2 focus:ring-[#DCFCE7] outline-none transition-all bg-gradient-to-r from-[#F0FDF4] to-[#DCFCE7]" 
                    />
                </div>
                <div>
                ...
                <button 
                    type="submit" 
                    className="w-full bg-gradient-to-r from-[#047857] to-[#10B981] text-white py-3 rounded-lg hover:shadow-lg font-bold transition-all uppercase tracking-wide"
                >
                    {T.nav.login}
                </button>
            </form>
            <p className="mt-6 text-center text-sm text-[#0F172A]/60">
                ...
                <button 
                    ...
                    className="font-bold text-[#047857] hover:text-[#0F5A2F] transition-colors"
                >
                    {T.nav.register}
                </button>
            </p>
