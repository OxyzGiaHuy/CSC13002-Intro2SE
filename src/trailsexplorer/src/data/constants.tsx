...
export const MOCK_TRAILS: Trail[] = [
  {
    ...
    duration_hr: 24,
    rating: 4.9,
    scenery: ["Đồi cỏ", "Rừng thông", "Đồi núi"],
    description: "Cung đường trekking đẹp nhất Việt Nam, băng qua các cao nguyên và rừng thông giữa Lâm Đồng và Bình Thuận.",
    imageUrl: "https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&q=80",
    reviews: [
      { full_name: "An Nguyen", username: "an_nguyen", avatarUrl: "https://picsum.photos/seed/an/40/40", rating: 5, comment: "Tuyệt vời! Một hành trình không thể bỏ qua với những người yêu thích trekking." },
      { full_name: "Binh Le", username: "binh_le", avatarUrl: "https://picsum.photos/seed/binh/40/40", rating: 4, comment: "Thử thách nhưng xứng đáng. Hãy chuẩn bị kỹ lưỡng trước khi đi." },
    ],
    isFavorited: false,
    lat: 11.53,
    lng: 108.6,
  },
  {
    ...
    duration_hr: 18,
    rating: 4.8,
    scenery: ["Núi cao", "Biển mây", "Rừng già"],
    description: "Chinh phục 'Nóc nhà Đông Dương', đỉnh núi cao nhất Việt Nam với độ cao 3.143m, mang lại tầm nhìn tuyệt đẹp ra dãy Hoàng Liên Sơn.",
    imageUrl: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&q=80",
    reviews: [
      { full_name: "Chi Pham", username: "chi_pham", avatarUrl: "https://picsum.photos/seed/chi/40/40", rating: 5, comment: "Tầm nhìn từ đỉnh núi thật kỳ diệu. Xứng đáng với từng bước chân!" },
    ],
    isFavorited: true,
    lat: 22.304,
    lng: 103.775,
  },
  {
    ...
    duration_hr: 5,
    rating: 4.6,
    scenery: ["Rừng thông", "Tầm nhìn thành phố"],
    description: "Một chuyến leo núi phổ biến trong ngày gần Đà Lạt, Langbiang mang lại tầm nhìn toàn cảnh thành phố và cao nguyên xung quanh.",
    imageUrl: "https://picsum.photos/seed/langbiang/800/600",
    reviews: [
      { full_name: "Dung Tran", username: "dung_tran", avatarUrl: "https://picsum.photos/seed/dung/40/40", rating: 4, comment: "Phù hợp cho chuyến đi trong ngày. Không quá khó và tầm nhìn rất đẹp." },
    ],
    isFavorited: false,
    lat: 12.055,
    lng: 108.438,
  },
  {
    ...
    duration_hr: 3,
    rating: 4.5,
    scenery: ["Rừng già", "Cây cổ thụ", "Hang động"],
    description: "Khám phá vườn quốc gia đầu tiên của Việt Nam. Cung đường dễ dàng này hoàn hảo cho gia đình và người mới bắt đầu.",
    imageUrl: "https://picsum.photos/seed/cucphuong/800/600",
    reviews: [
      { full_name: "Emi Sato", username: "emi_sato", avatarUrl: "https://picsum.photos/seed/emi/40/40", rating: 5, comment: "Đẹp và mang tính giáo dục cao. Trung tâm cứu hộ linh trưởng là một điểm nhấn." },
    ],
    isFavorited: false,
    lat: 20.316,
    lng: 105.613,
